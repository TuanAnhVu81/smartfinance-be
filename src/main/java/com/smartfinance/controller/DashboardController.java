...
public class DashboardController {
    ...
    public ResponseEntity<ApiResponse<SummaryResponse>> getSummary(
        ...
        SummaryResponse response = dashboardService.getSummary(userId, currentMonth, currentYear);
    ...
    public ResponseEntity<ApiResponse<List<CategoryChartResponse>>> getCategoryChart(
        ...
        List<CategoryChartResponse> response = dashboardService.getCategoryChart(userId, currentMonth, currentYear, type);
        return ResponseEntity.ok(ApiResponse.success(response));
    }
    ...
    public ResponseEntity<ApiResponse<List<MonthlyChartResponse>>> getMonthlyChart(
        ...
        List<MonthlyChartResponse> response = dashboardService.getMonthlyChart(userId, currentYear);
        return ResponseEntity.ok(ApiResponse.success(response));
    }

    // Helper: resolve Long userId from the authenticated UserDetails (username as lookup key)
